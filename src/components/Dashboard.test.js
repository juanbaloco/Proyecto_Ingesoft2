...
describe('Dashboard Component - handleLogout', () => {
  ...
  beforeEach(() => {
    ...
    useSelector.mockImplementation((selector) => {
      if (selector({ auth: { status: 'authenticated', displayName: 'Test User', uid: '123' } })) {
        return { status: 'authenticated', displayName: 'Test User', uid: '123' };
      }
      if (selector({ cdt: { solicitudes: [{}, {}] } })) {
        return { solicitudes: [{}, {}] }; // Simula 2 solicitudes
      }
      return {};
    });
  });
